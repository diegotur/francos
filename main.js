...
/* 
                    for (const elem of roa) {
                        elem.chofer = elem.CHOFER;
                        elem.coche = elem.COCHE;
                        elem.legajo = elem.LEGAJO;
                    } */
                    ...
                    roa1.forEach(function (elem) {
                        ...
                        Object.entries(elem).forEach(pair => {
                            if ((pair[1]) == " " || (pair[1]) == "V" || (pair[1]) == "V " || (pair[1]) == "n" || (pair[1]) == "v" || (pair[1]) == "**" || (pair[1]) == "*" || (pair[1]) == "e" || (pair[1]) == " V" || (pair[1]) == "VF" || (pair[1]) == " *" || (pair[1]) == "V*" || (pair[1]) == "  ") {
                                let x = pair[0];
                                delete elem[x];
                            };
